...
class InstanSeg(nn.Module):
    ...
    def update_binary_loss(self,binary_loss_fn_str):
        ...
        elif binary_loss_fn_str == "scnpcedice":
            from instanseg.utils.loss.compound_losses_scnp import SCNPCEDice
            binary_loss_fn_ = SCNPCEDice()
            def binary_loss_fn(pred, gt, **kwargs):
                return binary_loss_fn_(pred, gt)

        else:
            raise NotImplementedError("Binary loss function",binary_loss_fn_str,"is not implemented")
