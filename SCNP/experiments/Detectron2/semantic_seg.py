...
from .loss import SCNPCEDiceLoss
...
class DeepLabV3PlusHead(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        if not self.decoder_only:
            ...
            elif self.loss_type == "scnpcedice":
                self.loss = SCNPCEDice()
            else:
    ...
    def forward(self, features, targets=None):
        ...
        #if False:
        #    y2 = F.interpolate(y, scale_factor=self.common_stride, mode="bilinear", align_corners=False)
        #    t = torch.argmax(y2[0], axis=0).cpu().detach().numpy()
        #    Image.fromarray(np.uint8(t*255)).save("pred.png")
        #    print("llego")
    ...
    def losses(self, predictions, targets):
        ...
        #print(predictions.shape, targets.shape, self.loss_weight)
